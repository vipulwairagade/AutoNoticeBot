  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-card w3-round w3-margin">
        <div class="w3-white" >
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-car fa-fw w3-margin-right"></i> My Vehicles</button>
          <div id="Demo1" class="w3-hide w3-container">
            <button onclick="myFunction('veh1')" class="w3-bar-item w3-button">XX ## YYYY ####</button>
            <a href="#" class="w3-bar-item w3-button">XX ## YYYY ####</a>
            <a href="#" class="w3-bar-item w3-button">XX ## YYYY ####</a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding w3-hide" id="veh1">
              <h4>XX ## YY ####</h4>
              <h5>Vehicle Details :</h5>
              <ul type="circle">
              	<li><b>Registration Number :</b> SJKDH934JHSDF</li>
                <li><b>Chassis Number :</b> DSF9S87DASJDF</li>
                <li><b>Purchase Date :</b> DD/MM/YYYY</li>
              </ul>
            </div>
          </div>
        </div>
